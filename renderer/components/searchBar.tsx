...
export default function SearchBar({value, setValue, settings, setSearchSettings}:props) {
  return (
    <div className='flex w-full shrink grow border-2 rounded-md items-center px-1 h-full gap-1'>
        <input value={value} onChange={(e)=>{setValue(e.target.value)}} className='w-full outline-none placeholder:font-bold placeholder:text-neutral placeholder:opacity-50' placeholder='search' />
