...
export default function ExtraFieldsTab({entry, setEntry}:props) {
    ...
    return (
        <div className='flex flex-col w-full h-full shrink-0 overflow-y-hidden gap-5 p-2'>
            ...
            {/* add extrafield form */}
            <div className='flex flex-col w-full h-1/3 grow-0  shrink-0 rounded-lg p-1'>
                ...
                <form onSubmit={handleAddExtraField} className='flex flex-col h-full w-full justify-between'>
                    <div className='flex gap-2 w-full h-fit'>
                        ...
                        <input type="text" id='name' onChange={handleChange} value={newExtraField.name} className='flex border-2 border-base-300 outline-none focus:border-base-contentb px-1 bg-base-100 rounded-lg w-full' />
                    </div>
                    <div className='flex gap-2 w-full h-fit'>
                        <label className='flex w-12' >Data</label>
                        <input type="text" id="data"  onChange={handleChange} value={newExtraField.data.toString()} className='flex border-2 border-base-300 outline-none focus:border-base-content px-1 bg-base-100 rounded-lg w-full' />
                    </div>
