            ...
            <div className='flex w-full h-full p-2'>
                <div className='flex flex-col w-full h-full gap-2'>
                    {vault?.entryGroups.map((group, i)=>
                        <div key={i} className='flex border-2 h-12 w-full rounded-lg border-base-300 bg-white px-2 items-center text-normal gap-5'>
                            <div className='flex w-full text-subheading'>
                                {group.groupName}
                            </div>
                            <p className='flex w-40 justify-end text-nowrap'>
