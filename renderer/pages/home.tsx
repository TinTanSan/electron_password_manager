  ...
  return (
    ...
    {(vault !== undefined && vault.isUnlocked) && 
      <div className='flex w-full h-full gap-3 '>
        {/* sidebar */}
        <div className={`flex flex-col relative justify-center shadow-lg ${hamburgerOpen?'w-[20vw] items-end':'w-14 items-center'} h-full transition-all duration-[400ms] bg-base-100 p-2`}>
          ...
          <div className='flex flex-col  w-full h-full'>
            {
              ...
              <div className='flex flex-col gap-5 w-full h-full'>
                <div className='flex flex-col gap-5 w-full h-1/4 shrink-0 text-base-content'>
                  <div className='flex flex-col gap-2 w-full h-fit items-center text-lg'>
